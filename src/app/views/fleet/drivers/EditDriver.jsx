        ...
        <Card.Body>
          <Row className="mt-2">
            <Form>
              ...
              <Row>
                <Col md={6}>
                  <Form.Label>{t("driverType")}</Form.Label>
                  <InputGroup>
                    <Form.Control placeholder="--select driver designation--" />
                    <DropdownButton>
                      <DropdownItem>Item1</DropdownItem>
                    </DropdownButton>
                  </InputGroup>
                ...
                <Col md={6}>
                  ...
                  <InputGroup>
                    <Form.Control placeholder="--select employer--" />
                    <DropdownButton>
                      <DropdownItem>Item1</DropdownItem>
                    </DropdownButton>
                  </InputGroup>
              ...
              <Row>
                ...
                <Col md={6}>
                  <Form.Label>
                    {t("contractAttachment")} ({t("ifZiyad")})
                  </Form.Label>
                  <Form.Control type="file" />
                </Col>
              </Row>
