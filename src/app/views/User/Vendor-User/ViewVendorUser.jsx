...
export default class ViewVendorUser extends Component {
  ViewVendorData = [];
      ...
      <div>
        ...
        <Row>
          ...
          <Col className="d-flex flex-row-reverse mx-5">
            <Link to="/VendorUser/add">
              <Button size="lg">
                <i className="i-Add"></i> {t("Add Vendor User")}
              </Button>
            </Link>
          </Col>
        </Row>
